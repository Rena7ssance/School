...
extern "C" long syscallHandler(uint32_t* context, long num, long a0, long a1) {
    ...
    case 13: /* execv */
        {
             ...
             //Debug::printf("Gets into the kernel\n");
             char* name = (char*) a0;
             //Debug::printf("got name\n");
             //Debug::printf(name);
             //Debug::printf("\n");
             char** userArgs = (char**) a1;
             //Debug::printf("got userArgs\n");
             //Debug::printf(userArgs[0]);
             ...
             //Debug::printf("About to call execv\n");
    ...
    case 15: /* pipe */
        {
          Debug::printf("syscall pipe\n");
          BB<int> *boundedBuffer = new BB<int>(100);
          Process::current->resources->open(boundedBuffer);
          return 2;
        }
    case 16: /* dup */
        {
          Debug::printf("Dup a0 = %d, a1 = %d\n",a0,a1);
          return Process::current->resources->open(Process::current->resources->get(a0,ResourceType::OTHER));
        }
    default:
