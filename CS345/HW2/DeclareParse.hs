...
action_2 (10) = happyShift action_19
...
action_11 (20) = happyShift action_29
...
action_22 (14) = happyShift action_32
...
happyReduction_1 ((HappyAbsSyn4  happy_var_4) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn4
		 (DeclareList happy_var_2 happy_var_4
	) `HappyStk` happyRest
...
happyReduction_13 (HappyTerminal (Digits happy_var_1))
	 =  HappyAbsSyn9
		 (Number happy_var_1
	)
...
happyReduction_14 (HappyTerminal (Digits happy_var_2))
	_
	 =  HappyAbsSyn9
		 (Number (- happy_var_2)
	)
